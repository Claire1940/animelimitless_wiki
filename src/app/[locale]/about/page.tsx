...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://animelimitless.wiki'
  const path = '/about'

  return {
    title: 'About Anime Limitless Wiki - Your Ultimate Roblox Game Resource',
    description: 'Learn about Anime Limitless Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Anime Limitless Roblox game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'Anime Limitless Wiki',
      title: 'About Anime Limitless Wiki',
      description: 'Learn about our mission to provide the best Anime Limitless game resources and guides.',
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: 'Anime Limitless Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Anime Limitless Wiki',
      description: 'Learn about our mission to provide the best Anime Limitless game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About Anime Limitless Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Anime Limitless
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Anime Limitless Wiki</h2>
            <p>
              Anime Limitless Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Roblox game "Anime Limitless". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Anime Limitless Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Anime Limitless players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Anime Limitless Wiki as the <strong>go-to destination</strong> for every Anime Limitless player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Anime Limitless Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Anime Limitless Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Anime Limitless as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Anime Limitless mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Anime Limitless Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Anime Limitless or any official entities.
            </p>
            <p>
            ...
            <p>
              Anime Limitless Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@animelimitless.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@animelimitless.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@animelimitless.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@animelimitless.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@animelimitless.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@animelimitless.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@animelimitless.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@animelimitless.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Anime Limitless news.
