...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Anime Limitless Wiki',
    description: 'Copyright and intellectual property information for Anime Limitless Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Anime Limitless Wiki',
      description: 'Copyright and intellectual property information for Anime Limitless Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Anime Limitless Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Anime Limitless Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Anime Limitless Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Anime Limitless Developers</strong> - Creators of the Anime Limitless game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Anime Limitless</strong> - Trademark of the game developers</li>
              <li><strong>Anime Limitless Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Anime Limitless Wiki.
            </p>
            ...
            <p>
              ...
              Anime Limitless Wiki<br />
              Email: <a href="mailto:dmca@animelimitless.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@animelimitless.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Anime Limitless Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Anime Limitless Wiki (animelimitless.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@animelimitless.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@animelimitless.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@animelimitless.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@animelimitless.wiki</a>
            </p>
            <p>
